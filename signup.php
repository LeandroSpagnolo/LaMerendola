...
$nombreUsuario = substr( $nombreUsuario, 0, 60 );
...
if(!filter_var($emailUsuario, FILTER_VALIDATE_EMAIL)){
    ...
    if($mail_check->num_rows > 0 ){
        ...
        $sql = "INSERT INTO credencialesUsuarios (nombre, contrasena, email, ban, creacionDeCuenta, ultimaVezActivo, cuentaVerificada) VALUES ( '".$nombreUsuario."','".$contrasenaUsuario."','".$emailUsuario."',0,'".$date."','".$date."',0 )";
